...
ggarrange(
  rs2023 %>%
    ...
    geom_hline(yintercept = median_2023, linetype = "dashed") +
    annotate(
      "text", x = as.POSIXct("2023-04-30", format = "%Y-%m-%d"),
      y = median_2023 + 0.1, label = "2023"
    ) +
  ...
  rs2024 %>%
    ggplot(aes(x = data_inclusao, y = log_preco_unitario)) +
    geom_point(aes(color = cidade), alpha = 0.5) +
    geom_hline(yintercept = median_2023, color = "red", linetype = "dashed") +
    annotate(
      "text", x = as.POSIXct("2024-04-30", format = "%Y-%m-%d"),
      y = median_2023 - 0.1, label = "2023", color = "red"
    ) +
    geom_hline(yintercept = median_2024, linetype = "dashed") +
    annotate(
      "text", x = as.POSIXct("2024-04-30", format = "%Y-%m-%d"),
      y = median_2024 + 0.1, label = "2024"
    ) +
    scale_y_continuous(limits = c(1.5, 5)) +
    labs(
...
ggarrange(
  ...
  rs2024 %>%
    ...
    geom_point(aes(color = cidade), alpha = 0.5) +
    geom_smooth(method = "lm", se = FALSE, formula = y ~ x) +
    geom_hline(yintercept = median(rs2024$log_preco_unitario), linetype = "dashed") +
    labs(
